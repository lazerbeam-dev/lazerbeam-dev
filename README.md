...
- 💡 Created a front end only chess AI in javascript - it is a 3 layers deep minimax algorithm (with alpha beta pruning) with piece values hard coded. https://github.com/lazerbeam-dev/chessica
